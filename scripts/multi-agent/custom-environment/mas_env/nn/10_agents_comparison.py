...
def compute_avg_time(episodes, day, interval, num_agents):
    ...
    with open(f'./once_a_time/20260313_164436/csvs/csvs_batch_256/time_{episodes}_{day}_{interval}_{num_agents}agents_cuda.csv') as file:
        csvFile = csv.reader(file)
        cnt = 0
    ...
    with open(f'./reduced_states/csvs/csvs_batch_256/time_{episodes}_{day}_{interval}_{num_agents}agents_cuda.csv') as file:
        csvFile = csv.reader(file)
        cnt = 0
